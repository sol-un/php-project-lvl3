    ...
    <div class="row">
      <div class="col-12 col-md-10 col-lg-8 mx-auto text-white">
        ...
        <form action="https://php-l3-page-analyzer.herokuapp.com/urls" method="post" class="d-flex justify-content-center">
          <input type="hidden" name="_token" value="DdQvU2ccdtkwNswvYoo1x8V6eSCCMGByAQaX7cxy"> <input type="text" name="url[name]" value="" class="form-control form-control-lg" placeholder="https://www.example.com">
